...
(function () {
  ...
  const EN = {
    ...
    'data.stat4.num':      '120+',
    'data.source':         'Data source: Nagano Prefecture Tourism Dept., Hakuba Village Office, Japan Real Estate Research Institute (2025)',
    'data.visitors.title': 'Tourism Momentum on the Rise',
    'data.visitors.p1':    'Hakuba Village welcomed over 1.2 million visitors in 2024 — the most visited ski destination in Nagano Prefecture.',
    'data.visitors.p2':    'International visitors surpassed 35% of total arrivals in 2024, with Australia, Taiwan, and Southeast Asia as the top three source markets.',
    ...
    'tokyo.card1.list':      '<li>Persistent yen weakness and inflation have pushed prime Tokyo property values up over 30% in 5 years</li><li>Foreign investment in Japanese real estate hit a 15-year high in 2024, with demand outstripping scarce prime supply</li><li>Properties in Minato, Shibuya, and Shinjuku deliver dual value — personal use and investment</li><li>Japan\'s transparent, well-regulated real estate market is ideal for long-term overseas buyers</li>',
    'tokyo.card2.title':     'Vibrant Rental Market',
    'tokyo.card2.list':      '<li>Tokyo\'s residential vacancy rate holds at 2–3%, far below other major Asian cities</li><li>Steady demand from multinational expats and high-income professionals forms a reliable tenant base</li><li>Foreign visitors to Japan surpassed 36.87 million in 2024 — a record high — fuelling unprecedented short-term rental demand</li><li>Concentration of global HQs sustains robust long-term rental demand</li>',
    ...
    'tokyo.source':          'Data source: Tokyo Metropolitan Government, Japan Real Estate Research Institute, Statistics Bureau of Japan (2025)',
  ...
  const JA = {
    ...
    'data.stat1.num':      '120<em>万+</em>',
    'data.stat2.num':      '+40<em>%</em>',
    'data.stat4.num':      '120<em>日+</em>',
    'data.source':         'データ出典：長野県観光部、白馬村役場、日本不動産研究所（2025年）',
    'data.visitors.title': '急増するインバウンド需要',
    'data.visitors.p1':    '2024年、白馬村への年間来訪者数は120万人を突破し、長野県で最も人気のスキーリゾートです。',
    'data.visitors.p2':    '2024年の外国人来訪者比率は35%を超え、オーストラリア・台湾・東南アジアがトップ3市場として力強い成長を続けています。',
    ...
    'tokyo.card1.list':      '<li>円安の継続とインフレにより、東京都心の不動産価格は5年で30%以上上昇</li><li>2024年、外資による日本不動産への投資が15年ぶりの高水準に達し、希少な好立地物件への需要が供給を大幅に上回る</li><li>港区・渋谷区・新宿区の物件は自己使用と投資の双方で高い価値を発揮</li><li>日本の透明性の高い不動産市場は、海外長期投資家にとって理想的な環境</li>',
    'tokyo.card2.title':     '活況な賃貸市場',
    'tokyo.card2.list':      '<li>東京の住宅空室率は2〜3%と他のアジア主要都市を大きく下回る水準</li><li>多国籍企業の駐在員や高所得専門職からの安定した需要が信頼性の高い借主基盤を形成</li><li>2024年の訪日外客数は3,687万人を突破し過去最高を記録 — 短期賃貸市場の需要が空前の規模に拡大</li><li>世界的企業の集積がプレミアム住宅の長期賃貸需要を支えている</li>',
    ...
    'tokyo.source':          'データ出典：東京都庁、日本不動産研究所、総務省統計局（2025年）',
